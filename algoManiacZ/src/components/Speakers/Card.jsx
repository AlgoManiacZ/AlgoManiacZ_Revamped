    ...
    return (
        <>
            <MediaQuery minWidth={1224}>
                <div className="main">
                    <img className="spimg" src={imageUrl} />
            ...
            <MediaQuery maxWidth={1224}>
                <div
                    className="max-w-sm rounded-lg overflow-hidden shadow-lg mx-auto my-4 py-4  bg-[#000000]  bg-no-repeat bg-cover bg-center transition-all ease-in-out  hover:scale-105 hover:shadow-lg hover:shadow-hoverOrange "
                    style={{
                ...
                >
                    ...
                    <div className="px-6 py-4">
                        <div className="font-bold text-xl text-center mb-2 text-hoverOrange">
                            {name}
                        </div>
